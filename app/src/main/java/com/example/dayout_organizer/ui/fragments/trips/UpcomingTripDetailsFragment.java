...
public class UpcomingTripDetailsFragment extends Fragment {
    ...
    @BindView(R.id.upcoming_trip_details_go_to_passengers)
    LinearLayout upcomingTripDetailsGoToPassengers;
    ...
    private void initViews() {
        ...
        upcomingTripDetailsGoToPassengers.setOnClickListener(onPassengersClicked);
    ...
    private final View.OnClickListener onPassengersClicked = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (data.isUpcoming)
                isUpcoming = true;
            FN.addFixedNameFadeFragment(MAIN_FRC, requireActivity(), new PassengersListFragment(data.id, isUpcoming));
        }
    };
