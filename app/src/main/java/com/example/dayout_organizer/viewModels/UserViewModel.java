...
public class UserViewModel {
    ...
    public void editProfile(RequestBody methodName, RequestBody firstName, RequestBody lastName, RequestBody bio, RequestBody email, MultipartBody.Part photo) {
        successfulPairMutableLiveData = new MutableLiveData<>();
        apiClient.getAPI().editProfile(methodName,firstName,lastName,bio,email,photo).enqueue(new Callback<ResponseBody>() {
            @Override
    ...
    public void deleteUserProfilePhoto(){
        successfulPairMutableLiveData = new MutableLiveData<>();
        apiClient.getAPI().deleteProfilePhoto().enqueue(new Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                if (response.isSuccessful()) {
                    successfulPairMutableLiveData.setValue(new Pair<>(true, null));
